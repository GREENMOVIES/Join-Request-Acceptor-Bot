...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://graph.org/file/5aa160215d117a6e9e2e2-edd6badd671a6aeb00.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://')
            ],[
                InlineKeyboardButton("❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/armoviechat'),
                InlineKeyboardButton("🤖 ᴜᴘᴅᴀᴛᴇ", url='https://t.me/BLACKCATbot')
            ]]
        )
    )
